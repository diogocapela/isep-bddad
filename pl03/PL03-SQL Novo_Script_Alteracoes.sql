...
CREATE TABLE revisoes (
    id_revisoes          INTEGER GENERATED AS IDENTITY CONSTRAINT pk_revisoes_id PRIMARY KEY CHECK (id_revisoes > 0),
    matricula            VARCHAR(20) CHECK (REGEXP_LIKE (matricula, '([0-9]{2}-[A-Z]{2}-[0-9]{2})|([0-9]{2}-[0-9]{2}-[A-Z]{2})|([A-Z]{2}-[0-9]{2}-[0-9]{2})')) NOT NULL,
    data_hora_marcacao   TIMESTAMP UNIQUE NOT NULL,
...
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('65-87-GR', TIMESTAMP '2018-10-04 09:00:00', 'N');
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('83-QD-27', TIMESTAMP '2018-11-04 14:45:00', 'N');
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('42-90-AS', TIMESTAMP '2018-10-23 10:50:00', 'N');
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('XO-65-98', TIMESTAMP '2018-12-01 18:30:00', 'N');
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('65-87-GR', TIMESTAMP '2015-06-07 10:50:00', 'S');
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada) VALUES('XO-65-98', TIMESTAMP '2016-11-22 12:20:00', 's');